...
def build_agenda_block(config: dict) -> str:
    ...
    return (
        ...
        "horário que ela quer. Sempre preencha `telefone_cliente` com o "
        "número de WhatsApp desta própria conversa — nunca invente, "
        "deixe vazio se não tiver certeza. Se a ferramenta disser que o horário está "
