...
def check_and_book(
    ...
    # status fica "agendado" até o cronjob `agenda_lembrete_cron.py` (ou o
    # botão manual em /agenda) mandar a confirmação por WhatsApp, mais
    # perto do horário — não mais no instante da marcação (Fase 11,
    # revisado 2026-08-20: mandar na hora de marcar podia ser dias antes
    # do compromisso, cedo demais pra pedir confirmação).
    try:
